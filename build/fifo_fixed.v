...
module fifo
    ...
    reg [WIDTH-1:0] fifo_fifo_fifo_fifo_fifo_buffer[SIZE-1:0];
    ...
    assign read_data = fifo_fifo_fifo_fifo_buffer[read_ptr];
    ...
    always @(negedge CLK or posedge RST) begin
    	if(RST) begin
    		...
    		for(i=0; i<SIZE; i=i+1)
    			fifo_fifo_fifo_fifo_buffer[i] <= 0;
    	end else begin
    		if(read && write) begin
    			fifo_fifo_fifo_fifo_buffer[write_ptr] <= write_data;
    			read_ptr <= read_ptr + 1;
